...
class Trainer:
    ...
    def fit(self, x_train, y_train, x_test, y_test, epochs=5, batch_size=64, decay=True):
        """
        training process
        ...
        for epoch in range(epochs):
            ...
            if decay: self.optimizer.lr = 1/(1+.02*epoch) # learning rate decay
            print("Epoch %d, loss %.2f, train accuracy %.2f, test accuracy %.2f" % (epoch+1, loss, train_acc, test_acc))
