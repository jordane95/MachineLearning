...
def test():
    ...
    data_batches, label_batches = make_batch(read_data('ptb.train'), batch_size=BATCH_SIZE, time_step=TIME_STEP)
    ...
    for epoch in range(100):
        ...
        print("iteration %d, loss %f" % (epoch+1, loss))
...
def train():
    ...
    lm.save_param(save_path='model/lm.npz')
    ...
    plt.legend()
    plt.savefig('results/ptb/perplexity.jpg')
